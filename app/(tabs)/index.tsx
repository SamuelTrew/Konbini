...
export default function HomeScreen() {
  ...
  const requestLocationPermission = async () => {
    ...
    setErr("Permission to access location was denied. Please enable to allow the app to function.")
  }
  ...
  return (
    <ThemedView style={styles.container}>
      <MapView
        ...
        initialRegion={{latitude: 35.652832, longitude: 139.839478, latitudeDelta: 35.652832, longitudeDelta: 139.839478}}
        ...
        camera={{zoom: 10, center: {latitude: 35.65, longitude: 139.75}, heading: 0, pitch: 0}}
      >
        {location && <MarkerAnimated coordinate={{latitude: 35.652832, longitude: 139.839478}} />}
      </MapView>
